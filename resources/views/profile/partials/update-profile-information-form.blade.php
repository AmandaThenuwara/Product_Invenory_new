    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <x-text-input id="name" name="name" type="text" class="mt-1 block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md shadow-sm" :value="old('name', $user->name)" required autofocus autocomplete="name" placeholder="Inventory Manager" />
            </div>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <x-text-input id="email" name="email" type="email" class="mt-1 block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md shadow-sm" :value="old('email', $user->email)" required autocomplete="username" placeholder="inventory@stockwise.lk" />
